...
$manifest = [PSCustomObject]@{
    ...
    Summary = [PSCustomObject]@{
        ...
        DryRunOnly = $true
        GpuRendererImplementationPresent = [bool]$decisionReport.Summary.GpuRendererIntegrated
        CreatesNiagaraAssets = $false
        NiagaraAssetSetupCommand = "Scripts/setup_lidar_niagara_assets.ps1"
        RunsEditor = $false
        ...
        Boundary = "This package records evidence for the integrated GPU/Niagara renderer. Niagara assets are generated by setup_lidar_niagara_assets.ps1; this report does not create screenshots, modify assets, or stage files."
    }
    ManualEvidenceStillNeeded = @(
        ...
        "Run setup_lidar_niagara_assets.ps1 if the Niagara assets are missing.",
