...
$requiredTexts = @(
    ...
    [PSCustomObject]@{ Path = $acceptancePackageScript; Pattern = "SelectedReaderCandidatePath"; Label = "Acceptance package exposes selected reader candidate path" },
    [PSCustomObject]@{ Path = $acceptancePackageScript; Pattern = "ProducedLazEvidencePath"; Label = "Acceptance package exposes produced LAZ evidence path" },
