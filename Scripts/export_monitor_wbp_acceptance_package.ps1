...
$manualSteps = @(
    ...
    "Open Content/MA0T10/UI/WBP_VirtualSensorMonitorPanel and verify it loads and compiles without errors.",
    ...
    "Run PIE in the intended production or smoke-test map with AVirtualSensorUiHostActor or Level Blueprint binding.",
