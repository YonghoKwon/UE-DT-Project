...
$workAreas = @(
    ...
    (New-WorkArea `
        ...
        -Percent 39 `
        -Done "ROS2/Livox/RealSense placeholders, normalized frame handoff path, replay samples, JSON live bridge component, DTCore WebSocket transaction handler, safe routing guards, WebSocket live sample payload, editor sample/push helpers, automation names, and static adapter-plan validation are in place." `
        -Remaining "Actual SDK/ROS2/Livox/RealSense connections, WebSocket data-table registration/PIE smoke evidence, optional HTTP/UDP bridge wiring, and successful real-frame smoke tests remain."),
    (New-WorkArea `
