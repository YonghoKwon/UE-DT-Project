...
#include "VirtualSensorRecorderComponent.generated.h"

USTRUCT(BlueprintType)
struct MA0T10_DT_API FVirtualSensorRecordedFrame
{
    GENERATED_BODY()
...
class MA0T10_DT_API UVirtualSensorRecorderComponent : public UActorComponent
{
    GENERATED_BODY()

public:
    UVirtualSensorRecorderComponent();
