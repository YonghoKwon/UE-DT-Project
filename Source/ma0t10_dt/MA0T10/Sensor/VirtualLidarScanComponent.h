...
#include "VirtualLidarScanComponent.generated.h"
...
public:
    ...
    // Automatic scan entry points used by UVirtualSensorSchedulerSubsystem.
    ...
    {
        PrepareScheduledScan(Context.NowSeconds);
        const int32 Rays = FMath::Clamp(FMath::RoundToInt(Context.GameThreadBudgetMs * 128.0f), 128, 1024);
        return ProcessScheduledScanChunk(Rays) > 0;
    }
