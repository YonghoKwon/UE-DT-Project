...
void UCraneMechDriverComp::SetTargetPosition(const FCranePositionData& InPositionData)
{
	...
	// UE_LOG(LogMA0T10, Log, TEXT("[CraneMechDriverComp] Target - Trolley: %.2f, Hoist: %.2f, Gantry: %.2f"), TargetPosition.TrolleyPosition, TargetPosition.HoistHeight, TargetPosition.GantryPosition);
}
