...
패널 위치·접힘·LiDAR 표시 상태와 Monitor 확장 크기는 `Saved/SaveGames/MA0T10_VirtualSensorUI_v3.sav`에 저장됩니다. 기존 v1/v2 파일은 자동 변환되며 센서 Transform과 장비 설정은 이 SaveGame에 저장되지 않습니다.
